...
void motors_pin_config(void) {
	...
	motors_dir_ddr_reg |= (1<<motors_RB_pin) | (1<<motors_LF_pin) | (1<<motors_LB_pin) |(1<<motors_RF_pin);			// set **ONLY** motor pins as output
	motors_dir_port_reg &= ~((1<<motors_RB_pin) | (1<<motors_LF_pin) | (1<<motors_LB_pin) |(1<<motors_RF_pin) );			// stop motors initially
}
